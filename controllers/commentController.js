  ...
  createComment: async (req, res, next) => {
    ...
    try {
      ...
      await sequelize.query("INSERT INTO `event`(`user_id`, `event_type`, `event_author`, `event_title`, `event_content`, `url_address`, `event_date`) VALUES (?, ?, ?, ?, ?, ?, ?)", {
        type: sequelize.QueryTypes.INSERT,
        replacements: [req.body.post_author, '댓글', req.body.comment_author_nickname, req.body.post_title, req.body.comment_content, `/board/post-view/${req.params.post_id}`, date]
      });
